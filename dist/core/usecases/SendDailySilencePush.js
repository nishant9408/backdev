...
exports.SendDailySilencePush = void 0;
...
let SendDailySilencePush = class SendDailySilencePush {
    ...
    execute(notificationToken) {
        return __awaiter(this, void 0, void 0, function* () {
            Logger_1.default.info({ notificationToken, message: 'SendDailySilencePush' });
            yield this.notificationServiceAdapter.send(Notification_1.Notification.fromObject({
                token: notificationToken,
                data: {
                    'action-required': 'SEND_HEALTH_DATA',
                },
                apnsPriority: Notification_1.NotificationPriority.NORMAL,
            }));
        });
    }
};
SendDailySilencePush = __decorate([
...
exports.SendDailySilencePush = SendDailySilencePush;
//# sourceMappingURL=SendDailySilencePush.js.map