...
exports.ScheduleDailyScorePushes = void 0;
...
const SendDailyScorePush_1 = require("./SendDailyScorePush");
let ScheduleDailyScorePushes = class ScheduleDailyScorePushes {
    constructor(notificationServiceAdapter, repositoryAdapter, schedulerRegistry, sendDailyScorePush) {
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const job = yield this.createPush(request);
            const jobName = `${userId}-daily-score-push`;
            this.runJob(job, jobName);
            Logger_1.default.info({ userId }, 'daily score push init success');
        });
    }
    runJob(job, jobName) {
        try {
    ...
    createPush(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const time = Config_1.default.jobs.dailyScoreNotifications.time;
            const onComplete = null;
            const start = false;
            return new cron_1.CronJob(time, () => this.sendDailyScorePush.execute(userId, notificationToken), onComplete, start, timezone);
        });
    }
};
ScheduleDailyScorePushes = __decorate([
...
exports.ScheduleDailyScorePushes = ScheduleDailyScorePushes;
//# sourceMappingURL=ScheduleDailyScorePushes.js.map