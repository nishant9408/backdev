...
exports.ScheduleSilentDailyPushes = void 0;
...
const SendDailySilencePush_1 = require("./SendDailySilencePush");
let ScheduleSilentDailyPushes = class ScheduleSilentDailyPushes {
    constructor(notificationServiceAdapter, repositoryAdapter, schedulerRegistry, sendDailySilencePush) {
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info({ userId, token: request.notificationToken }, 'daily score silent push init success');
        });
    }
    runJob(job, jobName) {
        try {
    ...
    createPush(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const start = false;
            return new cron_1.CronJob(time, () => this.sendDailySilencePush.execute(notificationToken), onComplete, start, timezone);
        });
    }
};
ScheduleSilentDailyPushes = __decorate([
...
exports.ScheduleSilentDailyPushes = ScheduleSilentDailyPushes;
//# sourceMappingURL=ScheduleSilentDailyPushes.js.map