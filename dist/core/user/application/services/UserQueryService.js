...
const TryFind_1 = require("../../../sharedKernel/common/wrappers/TryFind");
...
let UserQueryService = class UserQueryService {
    constructor(userRepository, responseConverter) {
    ...
    getUserByIdHandler(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.responseConverter.map(User_1.User.fromObject(Object.assign({}, user)));
        });
    }
    getUserById(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield TryFind_1.TryFind.of(() => this.userRepository.findById(userId)).getOrThrow('User is not found');
            return User_1.User.fromObject(Object.assign({}, user));
        });
    }
    findUserByEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.userRepository.findByEmail(email);
            return user ? User_1.User.fromObject(Object.assign({}, user)) : null;
        });
    }
    getUserByEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.userRepository.findByEmail(email);
            return user ? this.responseConverter.map(User_1.User.fromObject(Object.assign({}, user))) : null;
        });
    }
};
